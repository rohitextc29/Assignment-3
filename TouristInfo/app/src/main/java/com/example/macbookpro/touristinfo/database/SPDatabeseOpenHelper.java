...
public class SPDatabeseOpenHelper extends SQLiteOpenHelper{
    ...
    public final static String COLUMNNAME_LOCAL="islocal";

    private final static String SQL_CREATE_QUERY="CREATE TABLE "+TABLE_NAME+" ("+COLUMNNAME_ENTRYID+" INTEGER PRIMARY KEY AUTOINCREMENT,"+COLUMNNAME_TITLE+" TEXT,"+COLUMNNAME_LOCAL+" TEXT DEFAULT 'no');";
